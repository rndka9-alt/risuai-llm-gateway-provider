...
export interface AdversarialV2Trajectory extends GoldenTrajectory {
  /** 이 trajectory가 공격하는 wall-clock recurrence admission의 가정. */
...
interface AppendTrajectoryBlueprint {
  attackSurface: string;
...
function buildAppendTrajectory(blueprint: AppendTrajectoryBlueprint): AdversarialV2Trajectory {
...
function createBoundaryJitterBaitTrajectory(): AdversarialV2Trajectory {
...
// 구분하는 양성 대조군으로 둔다.
function createBoundaryRefreshChainTrajectory(): AdversarialV2Trajectory {
...
function createDwellToTailChurnTrajectory(): AdversarialV2Trajectory {
...
function createLowFrequencyTailReplacementTrajectory(): AdversarialV2Trajectory {
...
function createHistoryRebaseTrajectory(): AdversarialV2Trajectory {
...
function createMixedPhaseLifetimeTrajectory(): AdversarialV2Trajectory {
...
export function createAdversarialV2Trajectories(): readonly AdversarialV2Trajectory[] {
  return [
    createBoundaryJitterBaitTrajectory(),
    createBoundaryRefreshChainTrajectory(),
    createDwellToTailChurnTrajectory(),
    createLowFrequencyTailReplacementTrajectory(),
    createHistoryRebaseTrajectory(),
    createMixedPhaseLifetimeTrajectory(),
  ];
}
