...
export function createSuppressedFrontierBranchBoundaryTrajectory(): GoldenTrajectory {
...
export function createLargeStablePrefixAdmissionTrajectory(): GoldenTrajectory {
  const messages = [
...
export function createLargeStablePrefixInvalidatedAfterAdmissionTrajectory(): GoldenTrajectory {
